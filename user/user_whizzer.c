...
/*
 * Phase 1 - Rotate motor slowly (MOTOR_STEP_IO_NUM PWM circle is large)
 * Phase 2 - Accelerate motor (MOTOR_STEP_IO_NUM PWM cycle is being decreased)
 * Phase 3 - Stop motor (sleep mode + brakes)
 * */


LOCAL uint32 step_periods_us[MAX_PWM_CYCLE_DECAY_STOP] = {
		4000, 3923, 3848, 3774, 3701, 3630, 3560, 3491, 3424, 3357,
		3292, 3228, 3166, 3104, 3043, 2984, 2925, 2868, 2812, 2756,
		2702, 2649, 2596, 2545, 2494, 2445, 2396, 2348, 2301, 2255,
		2209, 2165, 2121, 2078, 2036, 1994, 1954, 1914, 1874, 1836,
		1798, 1761, 1724, 1688, 1653, 1619, 1585, 1551, 1518, 1486,
		1455, 1424, 1393, 1363, 1334, 1305, 1276, 1249, 1221, 1194,
		1168, 1142, 1117, 1092, 1067, 1043, 1019, 996, 973, 951,
		929, 907, 886, 865, 845, 824, 805, 785, 766, 747,
		729, 711, 693, 676, 659, 642, 625, 609, 593, 578,
		562, 547, 532, 518, 504, 490, 476, 462, 449, 436,
		423, 411, 398, 386, 374, 362, 351, 340, 329, 318,
		307, 296, 286, 276, 266, 256, 247, 237, 228, 219,
		210, 201, 193, 184, 176, 168, 160, 152, 144, 137,
		129, 122, 115, 108, 101, 94, 87, 81, 74, 68,
		62, 55, 49, 43, 38, 32, 26, 21, 16, 10
};
